...
export class Role extends BaseMiddleware{
    ...
    handler(req: Request, res: Response, next: NextFunction): void {
        try {
            ...
            const permissions = {
                admin : ['/buses/get' , '/buses/create' , '/buses/update', '/buses/delete' ,'/user/get','/user/delete','/station/getAll' , '/station/create' , '/station/update', '/station/delete' ,  '/station/getByName' , '/station/get' , '/bus/bookedSeat','/bus/book/'],
